...
def parse_args():
    ...
    parser.add_argument("--map", default="l_shape_obstacle_45deg.png", help="Occupancy map png")
    ...
    parser.add_argument("--d-safe", type=float, default=0.02, help="Safety distance [m]")
    parser.add_argument("--teb-kappa", type=float, default=100.0, help="Gamma smoothing scale used in the optimizer")
    parser.add_argument("--v-max", type=float, default=0.40, help="Velocity limit [m/s]")
    parser.add_argument("--omega-max", type=float, default=0.8, help="Angular velocity limit [rad/s]")
    parser.add_argument("--a-max", type=float, default=0.8, help="Acceleration limit [m/s^2]")
    parser.add_argument("--alpha-max", type=float, default=2.0, help="Angular acceleration limit [rad/s^2]")
    parser.add_argument("--min-turning-radius", type=float, default=0.0, help="Minimum steering radius [m]")
    parser.add_argument("--save-prefix", default="", help="Optional prefix for saved summary/plots")
